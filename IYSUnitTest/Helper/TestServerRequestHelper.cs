...
namespace IYSUnitTest.Helper
{
    ...
    public class TestServerRequestHelper
    {
        ...
        /// <summary>
        /// Test için RequestHelper oluşturma 2
        /// </summary>
        /// <returns></returns>
        public static IRequestHelper CreateHelper2(TestLoginUserManager manager = null)
        {
            var _server = new TestServer(new WebHostBuilder()
                .UseConfiguration(new ConfigurationBuilder()
                    .AddJsonFile("appsettings.Development.json")
